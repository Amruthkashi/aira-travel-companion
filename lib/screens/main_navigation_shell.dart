...
class _MainNavigationShellState extends ConsumerState<MainNavigationShell> {
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          if (_sosActive) _buildSosCallOverlay(),
        ],
      ),
      bottomNavigationBar: Container(
        decoration: BoxDecoration(
          color: const Color(0xFF020617).withValues(alpha: 0.82), // Slate 950 with transparency
          boxShadow: [
            BoxShadow(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _buildMedicalRow('Full Name', 'Alex Mercer'),
                    const Divider(color: Color(0xFF334155), height: 16),
                    _buildMedicalRow('Blood Group', 'O-Positive (O+)'),
                    const Divider(color: Color(0xFF334155), height: 16),
                    _buildMedicalRow('Allergies', 'Penicillin, Peanuts'),
                    const Divider(color: Color(0xFF334155), height: 16),
                    _buildMedicalRow('Insurance Policy', 'Allianz Global #AZ-99201-X'),
                    const Divider(color: Color(0xFF334155), height: 16),
  ...
  Widget _buildSosCallOverlay() {
    final min = (_sosSeconds ~/ 60).toString().padLeft(2, '0');
    final sec = (_sosSeconds % 60).toString().padLeft(2, '0');

    return Positioned.fill(
      child: Container(
        color: const Color(0xFF0F172A).withValues(alpha: 0.95), // Full screen slate background
              ...
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, idx) {
                    ...
                    if (isDispatcher) textCol = const Color(0xFF818CF8);
                    if (isUser) textCol = const Color(0xFF34D399);
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          gradient: isSelected
              ? LinearGradient(
                  colors: [
                    const Color(0xFF6366F1).withValues(alpha: 0.25), // Electric Indigo
                    const Color(0xFF8B5CF6).withValues(alpha: 0.25), // Violet/Purple
                  ],
                  begin: Alignment.topLeft,
                  end: Alignment.bottomRight,
                )
