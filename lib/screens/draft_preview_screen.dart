...
class _DraftPreviewScreenState extends ConsumerState<DraftPreviewScreen> {
        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              const Text('No draft available', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
              const SizedBox(height: 16),
              ElevatedButton(
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Column(
          ...
          children: [
            Text('Draft Preview', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)),
            Text('STEP 4 — REVIEW & ACCEPT', style: TextStyle(color: Color(0xFF00B4D8), fontWeight: FontWeight.w800, fontSize: 9, letterSpacing: 0.5)),
          ],
        ),
        actions: [
          Container(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                _summaryPill(Icons.calendar_today, '${daySchedules.length} Days', Colors.white.withOpacity(0.15)),
                                const SizedBox(width: 8),
                                _summaryPill(Icons.place, '$totalActivities Places', Colors.white.withOpacity(0.15)),
                                const SizedBox(width: 8),
                                _summaryPill(Icons.attach_money, '\$${totalCostEstimate.toStringAsFixed(0)}', Colors.white.withOpacity(0.15)),
                              ],
                            ),
                            if (bookings.flights.isNotEmpty) ...[
                      ...
                      _buildValidationReportCard(validationReport),
                          ...
                          child: Row(
                            children: [
                              ...
                              TextButton(
                                ...
                                child: const Text('Resolve', style: TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.bold, decoration: TextDecoration.underline)),
                              ),
                            ],
                          ),
                        ),
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            color: isWarning
                                                ...
                                                : (isFreeTime
                                                    ? const Color(0xFF0F1E36).withOpacity(0.4)
                                                    : (isLogistic
                                                        ...
                                                        Text(activity.activity,
                                                          style: TextStyle(
                                                            color: isWarning
                                                                ...
                                                                : (isFreeTime
                                                                    ? const Color(0xFF00B4D8)
                                                                    : (isLogistic ? const Color(0xFFFBBF24) : Colors.white)),
  ...
  Widget _buildValidationReportCard(ValidationReport report) {
    return Container(
      width: double.infinity,
      padding: const EdgeInsets.all(16),
      margin: const EdgeInsets.only(bottom: 24),
      decoration: BoxDecoration(
        color: const Color(0xFF0F1E36), // Deep blue-gray
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 10,
            children: [
              _validationCheckItem('Flights Validated', report.flightsValidated),
              _validationCheckItem('Hotels Validated', report.hotelsValidated),
              _validationCheckItem('Transfers Validated', report.transfersValidated),
              _validationCheckItem('Attractions Validated', report.attractionsValidated),
              _validationCheckItem('Timeline Validated', report.timelineValidated),
            ],
          ),
  ...
  Widget _validationCheckItem(String label, bool isValid) {
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: [
        Icon(
